...
/*
    ...
    //thank you for writing the function in advance, although, I am a bit curious to see how memory efficient adding a 80 character string is for number conversion.
