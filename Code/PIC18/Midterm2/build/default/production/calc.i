...
volatile int POT1;
volatile int POT2;
volatile long halfer1;
volatile long halfer2;
volatile long new_POT1;
volatile long new_POT2;
volatile long TOTAL1;
volatile long TOTAL2;
volatile long TOTAL3;
...
# 42 "calc.c"
    ...
    while(1)
    {
        ...
        else if (PORTDbits.RD3 == 0 && PORTDbits.RD4 == 1)
        {
