...
# 55 "LiquidCrystal.c"
    void begin(unsigned char cols, unsigned char lines, unsigned char dotsize)
    {
        ...
        _displayfunction = 0x10 | 0x00 | 0x00;
        ...
        _delay((unsigned long)((41)*(1000000/4000.0)));
        sendCommand(0x20 | _displayfunction);
...
# 105 "LiquidCrystal.c"
    ...
    void displayON()
    {
        ...
        sendCommand(0x08 | _displaycontrol);
    }
# 182 "LiquidCrystal.c"
    void display()
    {
...
# 266 "LiquidCrystal.c"
    void setCursor(unsigned char col, unsigned row)
    {
        ...
        sendCommand(0x80 | (col + _rowOffsets[row]));
    }
